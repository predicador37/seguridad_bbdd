...
\title[Short title]{Sistemas de gestión de bases de datos y lenguajes de consulta} % The short title appears at the bottom of every slide, the full title is only on the title page
