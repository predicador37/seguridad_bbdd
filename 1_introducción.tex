...
Sin embargo, la seguridad en bases de datos ha sido muchas veces un aspecto al que \textbf{no se le ha dedicado la atención suficiente}. Con la aparición de normas como el Esquema Nacional de Seguridad o la ISO 27001 y la necesidad cada vez mayor de responder ante clientes y usuarios el escenario está cambiando y se está volviendo a poner el foco en la relevancia de estas cuestiones.
\end{frame}

\begin{frame}
	\frametitle{Contexto}
	La mayor parte de las veces, la seguridad en una base de datos consiste en aplicar los \textbf{principios ya probados} y utilizados en el ámbito de las redes de comunicaciones durante décadas: \\~\\
...
\begin{frame}
	...
	Hoja de ruta para adaptación al RGPD:
		...
		\item A partir del AR, realizar, en su caso, una \href{https://www.aepd.es/media/guias/guia-evaluaciones-de-impacto-rgpd.pdf}{evaluación de impacto} en la protección de datos
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Es necesario informar de qué se ha hecho con ellos.
	\end{itemize}
	\begin{exampleblock}{Ejemplos de falta de trazabilidad}
		\begin{itemize}
			\item No saber qué operador ha hecho la última operación de mantenimiento en una base de datos.
			\item No saber qué usuario ha borrado una tabla de una base de datos en un momento dado.
		\end{itemize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}
	...
	Muchas veces, por error o debido a políticas de acceso pobres, los privilegios otorgados a un usuario sobre la base de datos \textbf{exceden los requisitos de su puesto de trabajo}. También pueden permanecer sin modificar en el caso de que un trabajador cambie de rol o sea baja en la organización.
...
\begin{frame}
	...
	\end{itemize}
\begin{block}{Fallos autenticados en protocolos de red}
